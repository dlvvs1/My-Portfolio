...
export default function About() {
  return (
    <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12 animate-in fade-in duration-700 px-2 sm:px-0">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-slate-400 flex items-center justify-center gap-2 text-sm sm:text-base">
          <MapPin size={16} className="text-indigo-400 shrink-0" /> Dharmavaram, India 
        </p>
      ...
      <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
        ...
        {/* Profile Photo Card */}
        <div className="lg:col-span-4 flex flex-col justify-between max-w-xs sm:max-w-sm lg:max-w-none mx-auto w-full">
        ...
        <div className="lg:col-span-8 space-y-6 flex flex-col justify-between">
          ...
          {/* Bio Card */}
          <div className="p-5 sm:p-8 rounded-3xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm space-y-4">
            <div className="flex items-center gap-3 text-blue-400">
              <User size={24} />
              <h3 className="text-lg sm:text-xl font-bold text-white">Personal Profile</h3>
            </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            {/* Education Card */}
            <div className="p-5 sm:p-6 rounded-2xl bg-blue-500/10 border border-blue-500/20 space-y-1">
              <div className="flex items-center gap-3 text-blue-400 mb-2">
                <GraduationCap size={20} />
                <h4 className="font-bold text-white text-sm">Education</h4>
              </div>
              <p className="text-xs sm:text-sm text-slate-200 font-medium">B.Tech - CSE (AI & ML)</p>
            ...
            {/* Core Skills Card */}
            <div className="p-5 sm:p-6 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "React.js", "C++", "JavaScript", "Tailwind CSS", "OpenCV"].map((skill) => (
                  <span key={skill} className="text-xs font-medium bg-slate-900/60 px-2 py-1 rounded-lg border border-slate-700 text-slate-300">
                    {skill}
                  </span>
                ))}
              </div>
      ...
      <div className="flex flex-wrap justify-center gap-3 sm:gap-6 pt-4">
        ...
        <a 
          ...
          className="w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 text-sm"
        >
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="w-full sm:w-auto px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl font-bold transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 text-sm"
        >
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="w-full sm:w-auto px-6 py-3 bg-[#0077b5] hover:bg-[#00669c] text-white rounded-xl font-bold transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20 text-sm"
        >
